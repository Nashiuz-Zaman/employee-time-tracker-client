...
const ButtonBtn = ({
  ...
  const allClasses = `block min-w-[8rem] w-max capitalize transition-all duration-default rounded-defaultLg text-center px-6 py-2 3xl:text-xl 2xl:py-3 active:scale-[0.9] disabled:opacity-60 disabled:scale-100 disabled:cursor-not-allowed ${modifyClasses}`;
